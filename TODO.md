...
- [x] Refactor modular: worker en `src/worker/handlers/*`, front en
      `public/js/{color,upload,views}/`.
- [x] Endpoints `/api/edit` y `/api/people/{save,delete}` + panel de personas.
- [x] Wizard de subida en 4 pasos con modal de auth propio.
- [x] Pista opcional en `/login` vía variable `LOGIN_HINT`.
